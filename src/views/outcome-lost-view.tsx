...
const OutcomeLostView = () => {
    ...
    return (
        <motion.div
            ...
            <header
                className={`flex flex-col items-center content-center justify-center gap-2 from-black/0 to-rose-900 bg-gradient-to-t h-full w-full rounded-sm`}>
                <motion.h1
                    animate={{
                        rotate: [-10, 0],
                        transition: {
                ...
                <div>You&apos;ve been defeated by {latestOutcome?.enemyName}</div>
...
export default OutcomeLostView
